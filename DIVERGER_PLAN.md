# Converger → Diverger conversion plan (rev. 35)
...
2. **D-consolidate. Items 1–3 done (rev. 33–34); items 4–5 remain.** Docs (`CLAUDE.md`, `README.md`) rewritten and the default entrypoint fixed (item 3's default half only — see the item 3 entry). Left: item 4's module split and item 5's comment-archaeology cleanup, plus item 6's dead-weight deletion. No behaviour change in any of these.
