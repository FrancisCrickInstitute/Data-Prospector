...
class PipelineConfig:
    ...
    # req_score is gone these two judges are the entire quality bar (DEVELOPMENT_LOG.md §5), so every
    ...
    # run (DEVELOPMENT_LOG.md's Live Issue 31: three straight DOMAIN_NOTES vocabulary patches each
    ...
    # 0.08-0.19 (see DEVELOPMENT_LOG.md D4). A real default (unlike angle_model/judge_model) since
